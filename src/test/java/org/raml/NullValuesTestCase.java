...
public class NullValuesTestCase extends AbstractRamlTestCase
{
    ...
    {
        IRaml raml = parseRaml("org/raml/null-elements.yaml");
        Map<String, IMimeType> body = raml.getResources().get("/leagues").getAction(ActionType.GET).getResponses().get("200").getBody();
