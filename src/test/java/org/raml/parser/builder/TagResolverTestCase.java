...
public class TagResolverTestCase extends AbstractRamlTestCase
{
    ...
    {
        List<IValidationResult> validationResults = RamlValidationService.createDefault(new DefaultResourceLoader(), new CustomTagResolver()).validate(getResourceAsString(RAML), RAML);
