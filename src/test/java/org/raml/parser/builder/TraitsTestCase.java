...
public class TraitsTestCase extends AbstractRamlTestCase
{
    ...
    {
        IRaml raml = this.parseRaml("org/raml/traits/single-trait-add.yaml");
        Map<String, IParameter> queryParams = raml.getResources().get("/media").getAction(GET).getQueryParameters();
    ...
    {
        IRaml raml = this.parseRaml("org/raml/traits/single-trait-merge.yaml");
    ...
    {
        IRaml raml = this.parseRaml("org/raml/traits/single-trait-optional-add.yaml");
    ...
    {
        IRaml raml = this.parseRaml("org/raml/traits/single-trait-optional-merge.yaml");
        assertThat(raml.getResources().get("/media").getAction(GET).getQueryParameters().size(), is(2));
    }
